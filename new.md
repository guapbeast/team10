...
.parent {
    ...
    box-shadow: 0px 0px 8px 10px rgba(15, 191, 214, 0.1);
...
textarea:focus {
    ...
    outline: 0px;
    outline-offset: 0px;
    box-shadow: 0px 0px 1px 5px rgba(219, 14, 14, 0.12);
}
...
<body style="background:white">
          ...
          <div class="parent">
            <div class="div1"><img style="margin-top: 75px; margin-left: 150px; width: 150px; height: 150px;" src="https://d1nhio0ox7pgb.cloudfront.net/_img/o_collection_png/green_dark_grey/512x512/plain/suitcase.png"></div>
            <div class="div2" style="margin-left:50px"> <h2 style="margin-left:350px">Packing</h2> <br> 
            ...
            <div class="div3"><img style="margin-top: 75px; margin-left: 150px; width: 150px; height: 150px;" src="https://cdn-icons-png.flaticon.com/512/0/614.png"></div>
            <div class="div4" style="margin-left:50px"> <h2 style="margin-left:355px">Travel</h2> <br> 
            ...
            <div class="div5"><img style="margin-top: 75px; margin-left: 150px; width: 150px; height: 150px;" src="https://uxwing.com/wp-content/themes/uxwing/download/food-and-drinks/meal-food-icon.png"></div>
            <div class="div6" style="margin-left:50px"><h2 style="margin-left:360px">Food</h2> <br> 
            ...
            <div class="div9"><img style="margin-top: 75px; margin-left: 150px; width: 150px; height: 150px;" src="https://static.thenounproject.com/png/453090-200.png"></div>
            <div class="div10" style="margin-left:50px"><h2 style="margin-left:340px">Activities</h2> <br> 
            ...
            <div class="div11"><img style="margin-top: 75px; margin-left: 158px; width: 150px; height: 150px;" src="https://cdn-icons-png.flaticon.com/512/78/78686.png"></div>
            <div class="div12" style="margin-left:50px"><h2 style="margin-left:288px">Important Notes</h2> <br> 
