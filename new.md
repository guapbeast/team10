...
textarea:focus {
    ...
    outline: 35%;
    outline-offset: 35%;
    box-shadow: 35% 35% 1px 5px rgba(219, 14, 14, 0.12);
}
...
<body style="background:white">
          ...
          <b><hr style="height:2px;color:black;width:35%;background-color:black"></b>
          <br><br>
          </center>
          <div class="parent">
            ...
            <div class="div2" style="margin-left:35%"> <h2 style="margin-left:50%">Packing</h2> <br> 
            ...
            <div class="div4" style="margin-left:35%"> <h2 style="margin-left:50%">Travel</h2> <br> 
            ...
            <div class="div6" style="margin-left:35%"><h2 style="margin-left:50%">Food</h2> <br> 
            ...
            <div class="div8" style="margin-left:35%"><h2 style="margin-left:50%">Places to Stay</h2> <br> 
            ...
            <div class="div10" style="margin-left:35%"><h2 style="margin-left:50%">Activities</h2> <br> 
            ...
            <div class="div12" style="margin-left:35%"><h2 style="margin-left:50%">Important Notes</h2> <br> 
